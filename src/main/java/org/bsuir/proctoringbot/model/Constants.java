...
public class Constants {
    ...
    public static final String SEND_WORK_STUDENT_MENU_BUTTON_MESSAGE = "Отправить работу";
    public static final String GET_RESULTS_STUDENT_MENU_BUTTON_MESSAGE = "Посмотреть результаты";
    public static final String TAKE_TEST_STUDENT_MENU_BUTTON_MESSAGE = "Пройти тестирование";
    public static final String GET_INFO_STUDENT_MENU_BUTTON_CALLBACK = "button1_pressed";
    public static final String SEND_WORK_STUDENT_MENU_BUTTON_CALLBACK = "button2_pressed";
